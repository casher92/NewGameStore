...
namespace GameStore.Controllers
{
    ...
    public class PurchaseController : Controller
    {
        ...
        {
            var purchases = db.Purchases.Include(p => p.Customer).Include(p => p.Employee).Include(p => p.Product);
        ...
        public ActionResult Create([Bind(Include = "PurchaseID,CustomerID,ProductID,EmployeeID")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PurchaseID,CustomerID,ProductID,EmployeeID")] Purchase purchase)
        {
            if (ModelState.IsValid)
            {
